...
# Naming a thread "Dan Whitfield" when a stale card said "Daniel Whitfield" is
# the ordinary case; showing the family "Dan Whitfield / Daniel Whitfield /
# Sandra Voss" would be an unreadable hedge, and showing the bare number was
