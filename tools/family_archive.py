...
PAGES = [
    ...
    # The attorney-facing statement of position on the estate's vital documents.
    # Examiner-only: it is generated BY the review, reports review state in review
    # vocabulary, and is meant to be printed and handed over — not browsed by the
    # family alongside the photographs.
