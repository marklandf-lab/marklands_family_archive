...
from tools._archive_data import (  # noqa: E402
    ...
    near_miss_rows, vital_doc_label, estate_report_data,
...
EXAMINER_ONLY = {"review", "history", "guided", "junk", "collections", "report"}
...
class ArchiveCase:
    ...
    def section(self, page):
        ...
        if page == "report":
            ...
            # report and the screen it is generated from can never disagree.
            return estate_report_data(
