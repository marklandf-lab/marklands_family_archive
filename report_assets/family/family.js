...
(function () {
  ...
  // so the crumb they leave behind says "Rosa Hale" and not just "Emails".
  ...
  //                /emails?participant=r.hale@example.com can render a
  //                truthful crumb from the address, but only the correspondent
  //                card it was clicked from knows that address is "Rosa Hale".
  ...
  function correspondentCard(c) {
    ...
    // The card is the only place that knows this address is "Rosa Hale",
  ...
  // "Dan Okafor, Ana Ruiz, Theo Baird + 1" in the list and
  // "Dan Okafor (+15550100123), Ana Ruiz (+15550100456), ..." one click
