...
- **Never paste from the live case.** Use invented stand-ins — Rosa Hale, Dan Okafor,
  `+15550100123`, `r.hale@example.com`. An example teaches exactly as well with a fake name, and
